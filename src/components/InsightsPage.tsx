...
import { Sparkles, TrendingUp, BookOpen, Clock, Target, Medal, CheckCircle2, Users, Copy, Rocket, History } from 'lucide-react';
...
export default function InsightsPage({ expenses, profile, onBadgesUpdate }: InsightsProps) {
  ...
  return (
    <div className="w-full pt-2 px-4 pb-24 space-y-6">
      <div className="px-2">
         <h2 className="text-2xl font-serif text-rk-brown mb-1">Insights</h2>
         <p className="text-sm text-rk-brown/60">Pahami kemana duit lo ngalir.</p>
      </div>

      <div className="flex gap-4 border-b border-rk-brown/10 mb-6 px-2">
      ...
      {activeTab === 'ringkasan' ? (
        <>
          {/* Week Summary */}
          <div 
            className="bg-[#FFFDF8] border border-[#E2D5C3] rounded-sm p-6 pl-10 shadow-[2px_4px_12px_rgba(0,0,0,0.06)] relative overflow-hidden"
            style={{
        ...
        <div className="relative z-10 pt-1">
           <div className="flex items-center gap-2 mb-2 text-rk-brown">
             ...
             <h3 className="font-hand text-2xl font-bold tracking-wide">Weekly AI Summary</h3>
           </div>
      ...
      {/* Micro Lessons */}
      <div className="bg-rk-brown text-rk-cream rounded-2xl p-5 shadow-lg">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
        ...
        <div className="space-y-6">
          {!proyeksi ? (
            <div className="text-center py-10">
              ...
              <h3 className="font-serif text-xl text-rk-brown mb-2">Lihat Masa Depan Lo</h3>
            ...
            <motion.div initial={{opacity:0, y:20}} animate={{opacity:1, y:0}} className="space-y-6">
              {/* Latte Factor Card */}
              <div className="bg-[#FAF8F5] border border-rk-brown/10 rounded-xl p-6 shadow-[4px_4px_0_0_rgba(62,39,35,0.05)] relative">
                ...
                <div className="text-center my-6">
                   ...
                   <p className="text-3xl font-serif text-rk-red font-bold">Rp {proyeksi.latteFactor.yearlyCost.toLocaleString('id-ID')}</p>
                </div>
              ...
              {/* Time Machine Card */}
              <div className="bg-[#FDFBF7] border-2 border-dashed border-rk-brown/20 rounded-xl p-6 shadow-sm relative overflow-hidden">

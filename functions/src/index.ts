...
// Read API keys from the generated secret or environment
let ai: GoogleGenAI;

// We initialize GoogleGenAI inside the function scope to ensure
// process.env.GEMINI_API_KEY is available when Firebase Cloud Functions injects secrets
...
// Adding rate limiting in memory (for low-scale deployments this might be fine, but production usually uses Redis/Firestore)
...
export const api = onRequest({ 
    cors: true, 
    secrets: ["GEMINI_API_KEY"] // This tells Cloud Functions to load the secret
}, (req, res) => {
